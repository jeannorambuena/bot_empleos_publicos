...
from radar.sources.curico import SOURCE_ID, fetch_curico_candidates


CATALOG_PATH = ROOT / "data" / "source_candidates.json"
OUTPUT_DIR = ROOT / "output" / "sources" / "curico"
...
def main() -> int:
    try:
        ...
        opportunities, diagnostics = fetch_curico_candidates(candidate["discovery_url"])
    ...
    print("Dry-run Municipalidad de Curicó")
    print("------------------------------")
